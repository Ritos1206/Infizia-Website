...
import type { TechCapability } from "@/content/technology/types";

/**
 * Tech pillar capabilities — 6 things this pillar delivers.
 * 3-col grid on lg, 2-col on md, stack on mobile.
 */
          ...
          {items.map((c) => {
            ...
            return (
              <motion.div
                ...
                variants={revealItem}
                className={cn(
                  "group relative overflow-hidden rounded-2xl border border-white/10 bg-bg-base p-6 transition-all duration-300 ease-out hover:-translate-y-1 hover:bg-bg-elevated md:p-7",
                  a.hoverBorder,
                )}
              >
                <div

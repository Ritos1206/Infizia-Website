...
/**
 * iCON-specific problem section.
 *
 * Visualizes the wedge: five disconnected legacy tools collapse into a
 * single iCON tile in the center, with animated dashed lines flowing
 * inward to suggest consolidation.
 */
export function IconProblemVisual({
  kicker,
  title,
  body,
}: {
...
/* -------------------------------------------------------------------------- */
/*  Tools-convergence visual: 5 legacy tool tiles → 1 iCON tile               */
/* -------------------------------------------------------------------------- */
...
function ToolsConvergence() {
  return (
    <div className="relative">
      {/* Subtle radial glow behind the iCON tile */}
      ...
      <div className="grid grid-cols-2 items-center gap-6 lg:grid-cols-12 lg:gap-4">
        ...
        {/* Center: iCON tile + connector lines */}

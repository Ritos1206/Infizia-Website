...
/**
 * Four scenario visuals for EyeCON's ProductShowcase slider.
 * Each one is a desktop-style UI fragment that shows EyeCON in a real
 * sales situation — different from the phone hero which cycles through
 * mobile screens.
 */

export const EYECON_SHOWCASE_MOMENTS: ShowcaseMoment[] = [
  {
    id: "morning",
    kicker: "Monday · 8:42 AM",
    title: "Walk in already briefed.",
    body: "Open EyeCON to find every meeting and call on your day pre-loaded with company intel — funding, news, decision makers, last touchpoints. No more scrambling through tabs.",
  ...
  },
  {
    ...
    body: "Tap Live Meeting before walking into a customer office. EyeCON listens, transcribes, separates speakers, and tags action items — so you walk out with the work already done.",
  ...
  },
  {
    ...
    body: "After EyeCON pulls a 360° company brief, chat with it. Get grounded answers to messy questions — about products, hiring patterns, procurement preferences — without a single Google tab.",
  ...
  },
  {
    ...
    body: "EyeCON pulls up your pipeline view: every deal advanced or stalled this week, every action item in flight. You scan, ship two emails, and head home.",
    visual: <ScenarioWrap />,
  },
];

...
/**
 * Service hero — used by the 4 bespoke service pages.
 *
 * Mirrors `SolutionHero` shape: 2-col split (copy left, bespoke visual
 * right), per-accent kicker, primary CTA = Book a Demo, secondary CTA
 * = Corporate Brochure (per D-69 — same wiring as solutions).
 */
        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-16">
          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              <span>
                Discovery → build → run — fixed-scope, retainer, or advisory.
              </span>
            </motion.div>
          </div>

...
import type { ServicePain } from "@/content/services/types";

/**
 * Service pain-points section — 4 frictions the buyer is paying for
 * before this service line gets engaged. Mirrors `SolutionPainPoints`
 * but tuned for service narratives ("we hire 3 vendors and still ship
 * late") rather than industry narratives.
 */

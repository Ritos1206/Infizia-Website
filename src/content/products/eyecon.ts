/**
 * EyeCON — flagship Sales product content.
 * Source of truth: docs/DEVLOG.md → "Finalized Product Content" → EyeCON.
 *
...
export const eyeconContent: FlagshipProductContent = {
  slug: "eyecon",
  name: "EyeCON",
  vertical: "Sales",
  accent: "teal",
  ...
  features: {
    ...
    items: [
      ...
      },
      {
        ...
        body: "Ask plain-English questions about any company you've researched. \"What did they ship last year?\" \"Who's the right person on procurement?\" Answers grounded in the research EyeCON pulled.",
      },
      {
        icon: PhoneCall,
      ...
      },
      {
        ...
        body: "Open Live Meeting before a face-to-face . EyeCON captures the full conversation, gives you a speaker-separated transcript, mood read, and action-item summary in minutes.",
      },
      {
        icon: Mail,
      ...
      },
      {
        ...
        body: "After the meeting, ask EyeCON anything about what was said. \"What did the CTO commit to?\" \"What's the procurement timeline?\" Answers pulled from the actual transcript.",
      },
    ],
  },
  ...
  useCases: {
    ...
    lede: "Whether you run a regional field force, an inside-sales floor, or chase enterprise deals on long cycles — EyeCON keeps every interaction on one Lead.",
    items: [
      {
        icon: Target,
      ...
      },
      {
        ...
        body: "High-velocity outbound where research time and call volume directly drive pipeline. EyeCON cuts both bottlenecks with AI briefs and one-tap dialer.",
      },
      {
        icon: Users,
  ...
  caseStudy: {
    intro:
      "A 30-rep B2B SaaS team replaced four tools — legacy CRM, separate dialer, research platform, meeting recorder — with EyeCON.",
    stats: [
